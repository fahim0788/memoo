...
export function IconLockPrivate({ size = 20, className = "", style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <path d="M61.44,0A61.44,61.44,0,1,1,0,61.44,61.44,61.44,0,0,1,61.44,0ZM45.05,55.81V45.05a16.39,16.39,0,1,1,32.78,0V55.81h4.1a3.07,3.07,0,0,1,3.07,3.07V85.76a3.07,3.07,0,0,1-3.07,3.07H40.95a3.07,3.07,0,0,1-3.07-3.07V58.88a3.07,3.07,0,0,1,3.07-3.07h4.1Zm8.2,0h16.38V45.05a8.19,8.19,0,1,0-16.38,0V55.81ZM61.44,65a5.12,5.12,0,0,1,2.56,9.56v6.57H58.88V74.52A5.12,5.12,0,0,1,61.44,65Z" />
    </svg>
  );
}
...
export function IconTrophy({ size = 20, className = "", style }: IconProps) {
  return (
    <svg
      ...
      style={style}
    >
      <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M4 22h16M10 22V14.4a2 2 0 0 1 .6-1.4L12 12l1.4 1a2 2 0 0 1 .6 1.4V22M6 2h12v7a6 6 0 0 1-12 0V2z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#flagClip)">
        ...
        <rect x="15.34" y="4" width="6.67" height="16" fill="#EF4135" />
      </g>
    </svg>
  );
}
